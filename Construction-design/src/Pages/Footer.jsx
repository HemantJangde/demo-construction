...
export default function Footer() {
  ...
  const whatsappNumber = "6267995795"; // Example: 91 for India + number
        ...
        <div className="grid md:grid-cols-4 gap-10 pb-10 border-b border-white/10">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              {[Facebook, Twitter, Linkedin, Instagram].map((Icon, i) => (
                <div
                  key={i}
                  className="bg-white/10 hover:bg-orange-500 transition p-2 rounded-full cursor-pointer"
                >
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-300">
              ...
              <li>✉️ info@kkconstruction.com</li>
              <li>🏗️ 2464 Royal Ln, Pune, Maharashtra, India</li>
            </ul>
          </div>
